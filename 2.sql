...
1) manfacture_table ='create table  manufacture (manufacture_id INT PRIMARY KEY,product_name VARCHAR(50) NOT NULL,color VARCHAR(20) NOT NULL,number_of_items INT NOT NULL, date_of_manufacture DATE NOT NULL, defective_item BOOLEAN NOT NULL)'
...
4)In the “goods” table, it should include different items that are manufactured by the company along with the goods id, manufactured date. 